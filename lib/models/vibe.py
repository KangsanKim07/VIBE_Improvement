...
class VIBE(nn.Module):
    def __init__(
            ...
            bidirectional=False,
            use_residual=True,
            pretrained=osp.join(VIBE_DATA_DIR, 'spin_model_checkpoint.pt'),
    ):
        ...
        # self.encoder_layer = nn.TransformerEncoderLayer(d_model=2048, nhead=8)
    ...
    def forward(self, input, J_regressor=None):
        ...
        feature = feature[:, 1:, :]
        batch_size, seqlen = feature.shape[:2]
        # feature = self.transformer(input)
